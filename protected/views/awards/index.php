...
<div class="isi">          
          <?php 
          foreach($model['samping'] as $key => $samping){
            echo "<h2>".$key."</h2>";
            echo "<ol>";
            foreach($samping as $details){
              echo "<li>".$details."</li>";
            }
            echo "</ol>";
          }
      ...
      <div class="kanan">
        ...
        <div class="content">
          <div class="jeda"></div>
<div id="slider2_container" style="position: relative; width: 600px; height: 300px; margin:0 auto;">
          ...
          <!-- Slides Container -->
          <div u="slides" style="cursor: move; position: absolute; left: 45px; top: 20px; width: 500px; height: 280px;
              overflow: hidden;">
              <?php
              foreach($model['gale'] as $galery){
                echo '<div><a u=image href="#"><img src="'.Yii::app()->request->baseUrl.'/uploads/images/'.$galery['gambar'].'" /></a></div>';
              }
              ?> 
          </div>