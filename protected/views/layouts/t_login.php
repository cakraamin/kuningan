...
<html lang="en"><head>
    <meta charset="utf-8">
    <title>Sampurna Kuningan - Admin</title>
    ...
    <script src="<?php echo Yii::app()->request->baseUrl; ?>/assets/template/AircraftAdmin/lib/jquery-1.11.1.min.js" type="text/javascript"></script>
