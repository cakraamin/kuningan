...
<div class="isi">
          ...
          <ol>
            <?php
            foreach($modele['samping'] as $samping){
                echo "<li>".$samping."</li>";
            }
            ?>            
          </ol>
      ...
      <div class="kanan">
        ...
        <div class="content">
          <div class="jeda" style="height:70px;"></div>
<div id="slider1_container" style="position: relative; top: 0px; left: 0px; width: 810px; height: 300px; overflow: hidden; ">
        ...
        <!-- Slides Container -->
        <div u="slides" style="cursor: move; position: absolute; left: 140px; top: 0px; width: 600px; height: 300px; overflow: hidden;">
            <?php
            foreach($modele['gale'] as $galery){
                ?>
                <div>
                    <div u="thumb">
                        <div class="t"><?php echo $galery['judul_gale']; ?></div>
                        <img class="i" src="<?php echo Yii::app()->request->baseUrl; ?>/uploads/crop/<?php echo $galery['gambar']; ?>" />
                    </div>
                    <img u="image" src="<?php echo Yii::app()->request->baseUrl; ?>/uploads/images/<?php echo $galery['gambar']; ?>" /> 
                </div>
                <?php
            }
            ?>             
