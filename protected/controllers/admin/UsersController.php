...
class UsersController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Users']))
		{
			...
			$salt = $this->generate_code(10);			
			$acak = md5($model->pass_word.$salt);			
			$model->pass_word = substr($acak, 4, 10);
			$model->salt_password = $salt;			
	...
	public function actionDeleteAll()
	{
		...
		Users::model()->deleteAll('id_user IN (' . $allIds . ')');		
	}
}
